...
export const LORE_DATA = {
    ...
    'LIB_ENTIDADES': {
        text: [
            "--- Entidades ---",
            "Las entidades que habitaban esta realidad eran las encargadas de crear, administrar, supervisar, destruir y guardar todas y cada una de ellas.",
            "Las entidades pertenecían a una instalación que se dedicaba a algo en específico, esto significa que cada instalación tenía un número de entidades de un mismo tipo trabajando ahí dentro.",
            "Existen algunas entidades que hasta ahora se conoce algo de ella debido a cierta información:",
            " ",
            "Arquitectos: Se encargan de diseñar la realidad, sus biomas, la materia que conforma los lugares o regiones de cada uno de los universos, sus moléculas, el aspecto general de este. Toda esta información es registrada.",
            " ",
            "Ingenieros: Se encargan de la lógica de la realidad, sus leyes físicas, cuánticas, sociales, políticas, dominantes, etc. Crean el funcionamiento de la realidad misma.",
            " ",
            "Núcleos: Son los que dan el visto bueno y el último filtro para la creación de la realidad. Analizan cada uno de los parámetros de esa realidad y autorizan su creación.",
            " ",
            "Recursos: Se encargan de crear y programar el comportamiento de cada una de las entidades que vayan a existir en esa realidad, sus recursos, funcionamiento y pensamiento.",
            " ",
            "Programadores: Crean la realidad en sí. Reciben información de las entidades correspondientes (arquitectos, ingenieros, etc) y luego programan y estructuran todo el código para la simulación. También se encargan de corregir errores y eliminar entidades que se percaten de que su realidad es una simulación (aviones detenidos, pájaros volando sin moverse, etc).",
            " ",
            "Guías: Clasifican, ordenan y colocan estas realidades ya creadas dentro del sistema, como si de un cartucho se tratase. Deciden dónde colocarla para su correcto funcionamiento y tal vez, para servir de energía a una realidad conjunta paralela.",
            " ",
            "Viajeros: Son las únicas entidades que pueden viajar a estas realidades. Se encargan de analizarlas, investigarlas y recabar información para enviarla a los programadores. Están por encima de las leyes de la simulación, por lo que no envejecen, no comen, no duermen, etc. Al conocer los códigos, pueden actuar como si fueran dioses. Envían su información mediante huellas en la realidad (un libro, un evento histórico, la destrucción de un planeta), que los programadores interpretan.",
            " ",
            "Investigadores: Toman la información recibida por el programador y la someten a subrutinas neurales. La información extraída es analizada y utilizada para futuras creaciones.",
            " ",
            "Introduce 'VOLVER' para regresar al índice."
        ],
        type: 'prompt',
