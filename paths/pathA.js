...
const PATH_A_NODES = [
        ...
        func: function() {
            typeWriter("--- RECALIBRANDO FRECUENCIA ---", function() {
                showLoadingBar(2000, function() { // Simula una carga
                    ...
                    terminalInput.value = "";
                    terminalInput.setAttribute('placeholder', 'Ingresa la clave de acceso...');
    ...
    // NOTA: El nodo `final_A_message` que estaba antes se ha integrado en `pathA_completed_scenario`
    // para hacer la narrativa de éxito más directa y cohesiva.
];